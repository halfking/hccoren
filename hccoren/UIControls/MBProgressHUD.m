...
//        CGSize dims = [self.labelText sizeWithFont:self.labelFont];
        ...
        if (nil != self.detailsLabelText) {
            ...
            CGRect rect = [detailsLabel.text boundingRectWithSize:CGSizeMake(frame.size.width - 4*margin, maxHeight) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:detailsLabel.font} context:nil];
            CGSize labelSize = rect.size;
            
//            [detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize: lineBreakMode:detailsLabel.lineBreakMode];
