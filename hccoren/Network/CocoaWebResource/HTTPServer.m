...
- (void)setupBuiltInDocroot:(NSString*)dir
{
//    UDManager * ud = [UDManager sharedUDManager];
    NSString* docroot = dir;// [ud getFilePath:[ud webRootFileDir]];//[NSString stringWithFormat:@"%@/tmp/docroot", NSHomeDirectory()];
    NSFileManager *manager = [NSFileManager defaultManager];
    if(![manager fileExistsAtPath:docroot])
    {
        NSError *error;
